...
public class FacilityRepositoryIplm implements IFacilityRepository {
    ...
    static {
        facilityMap.put(new Room("SVRO-1234","Room402","100","200","2","Date", "FreeMassage"),5);
        facilityMap.put(new Room("SVRO-6789","Room301","150","350","4","Date","FreeBuffet"),3);
        facilityMap.put(new Room("SVRO-5678","Room505","100","4000","2","Month","FreeMassage"),4);
        facilityMap.put(new Room("SVRO-5432","Room305","100","40000","2","Year","FreeMassage"),1);
        facilityMap.put(new Villa("SVVL-2345","Villa102","300","700","4","Date","4*", "55","2"),5);
        facilityMap.put(new Villa("SVVL-0012","Villa203","400","1000","8","Date","5*","100","3"),1);
        facilityMap.put(new Villa("SVVL-8483","Villa305","300","18000","4","Month","4*","55","2"),1);
    }
    @Override
